...
<html lang="en">
  <head>
    ...
    <title>Estate Agent a Real Estate Category Bootstrap Responsive Website Template | Services :: pomonart</title>
     <!-- web fonts -->
    ...
    <div class="container py-lg-3">
        ...
        <div class="row w3-services-grids py-lg-5">
            ...
            <div class="col-lg-7 w3-services-right-grid mt-lg-0">
                ...
                <a class="btn btn-secondary btn-theme3 mt-3" href="contact.php"> Contact Us</a>
            </div>
