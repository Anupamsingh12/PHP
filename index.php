...
<body>
        ...
        <div class="d-grid grid-col-4 footer-top-29">
          ...
          <div class="footer-list-29 footer-3">
            <div class="properties">
              ...
              <a href="#"><img src="assets/images/g7.jpg" class="img-responsive" alt="">
              ...
              <a href="#"><img src="assets/images/g9.jpg" class="img-responsive" alt="">
  ...
  <script>
    ...
    $(function() {
      ...
      autocomplete(document.querySelector(".cities"));
      autocomplete(document.getElementsByClassName("cities")[1]);
    ...
    function autocomplete(inp) {
      ...
      inp.addEventListener("input", async function(e) {
        ...
        arr = await getLocations(val);
        arr = arr.map(e => e.city_name);
